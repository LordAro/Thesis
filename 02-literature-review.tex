...
Gschwind et.\ al.~\cite{Gschwind2000BinaryTranslation} describe the design
...
x86 instructions, being careful to replicate all side-effects such as interrupts
and memory access ordering. While doing this, it collects information on the
instructions running on it, for example how often particular instructions are
